"""
Evaluate the trained GRU on the internal val set.

Produces:
    runs/eval/confusion_matrix.png
    runs/eval/roc_curve.png
    runs/eval/metrics.txt
...
def main():
    ...
    ax.plot(fpr, tpr, lw=2, label=f'GRU (AUC = {roc_auc:.3f})')
    ...
    ax.set_title('ROC Curve — Val Set')
